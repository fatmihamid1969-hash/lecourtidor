...
const GITHUB_REPO = "lecourtierdore";
...
function extractPropertyFromIssue(issue) {
  // نستخدم Regular Expressions لاستخراج الحقول من نص Issue
  const body = issue.body || "";
  const title = issue.title || "";
  // استخراج الحقول من النص (يمكنك تحسين regex حسب تنسيقك)
